...
> 来源：[https://github.com/softaworks/agent-toolkit/tree/main/skills/draw-io](https://github.com/softaworks/agent-toolkit/tree/main/skills/draw-io) · 本地摘录，未走 `npx skills i` 安装；需要时在对话里 @ `flow-spec/references/external/draw-io/SKILL.md` 当系统提示用。
...
上游另有 pre-commit / `convert-drawio-to-png.sh`，未随本摘录打包。本机已装 draw.io 桌面 CLI 时可直接导出：
...
- [Layout Guidelines](references/layout-guidelines.md)（本目录已收录）
- AWS 大图示与脚本见上游：[aws-icons.md](https://github.com/softaworks/agent-toolkit/blob/main/skills/draw-io/references/aws-icons.md) · [find_aws_icon.py](https://github.com/softaworks/agent-toolkit/blob/main/skills/draw-io/scripts/find_aws_icon.py)
